...
/**
  ...
  * https://leetcode.com/problemset/algorithms/?search=anagram
  *
...
object CheckAnagrams {
  ...
  def isAnagram(string1: String, string2: String): Boolean = {
    ...
    val string1Array = string1.toCharArray()
    val string2Array = string2.toCharArray()

    var letterCounts = new Array[Int](256)
    ...
    var isBalanced = true
    for (index <- 0 until letterCounts.length) {
